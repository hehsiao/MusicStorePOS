...
public class CustomerController implements ActionListener, ExceptionListener
{
	...
	{
		AMS.updateStatusBar("Purchase Order Details of ReceiptID: " + receiptID);
		AMS.updateStatusBar("Total Price for order: " + purchase.getPurchaseTotal(receiptID));
		AMS.updateStatusBar("You have ordered the following items.");
