...
INSERT into Purchase (receiptId, pdate, cid, cardnum, expiryDate, expectedDate, deliveredDate) values (1, sysdate, 10, 6789543, '2013-08-06', '2012-09-05', '2012-10-12');
INSERT into PurchaseItem values (1, 1, 2);
INSERT into PurchaseItem values (2, 2, 1);
INSERT into PurchaseItem values (2, 2, 3);
INSERT into PurchaseItem values (4, 4, 5);
INSERT into ReturnItem values (1, 1, 3);
INSERT into ReturnItem values (2, 2, 3);
INSERT into ReturnItem values (3, 3, 3);
INSERT into Return values (1, sysdate, 1);
INSERT into Return values (2, sysdate, 2);
INSERT into Return values (3, sysdate, 3);